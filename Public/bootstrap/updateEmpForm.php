...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				var empid = "<?php echo $_GET["empid"];?>";
				$.getJSON("../course09_RequestAndResponse/loadEmpById.php",{empid:empid},function(emp){
					$("#empid").val(emp.empid);
					...
					$.getJSON("../course09_RequestAndResponse/getAllDept.php",function(data){
						$("#deptid").empty();
						$("#deptid").append('<option value="0">按部门搜索</option>');
			...
			function backToListPage() {
				location.href = "showEmp.view.php";
			}
		</script>
	</head>
	<body>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form id="ff" onreset="backToListPage();" action="../course09_RequestAndResponse/updateEmp.php" method="post">
